				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							{
								if($row["namaBarangWeb"] == $itemName)
								{
									$name = $row["namaBarangWeb"];
									$harga = $row["hargaJual"];
									$kelompok = $row["kelompokBarang"];
									$stock = $row["stockPostWeb"];
							...
							echo "</div>";
							echo "<div>";
							echo "	<h3 class=\"product-price\"> Rp. ". $price_format_number . "</h3>";
							echo "	<span class=\"product-available\">". $available ."</span>";
							echo "</div>";
							...
							echo "	<li><a href=\"#\"><i class=\"fa fa-heart-o\"></i> add to wishlist</a></li>";
							echo "	<li><a href=\"#\"><i class=\"fa fa-exchange\"></i> add to compare</a></li>";
							echo "</ul>";

							echo "<ul class=\"product-links\">";
							echo "	<li>Category:</li>";
							echo "	<li><a href=\"#\">". $kelompok ."</a></li>";
							echo "</ul>";
							echo "</ul>";
							?>
						</div>
